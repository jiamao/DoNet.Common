...
namespace DoNet.Common.Text
{
    public class Security
    {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static string Des3Encrypt(string key, string source)
        {
            ...
            var ps = desencrypt.TransformFinalBlock(bs, 0, bs.Length);
            return Convert.ToBase64String(ps);
        }
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static string Des3Decrypt(string key, string source)
        {
            var des = new TripleDESCryptoServiceProvider();
            des.Key = Encoding.ASCII.GetBytes(key);
            des.Mode = CipherMode.ECB;
            ...
            var psource = Convert.FromBase64String(source);
            var ps = desencrypt.TransformFinalBlock(psource, 0, psource.Length);
            return Encoding.UTF8.GetString(ps);
        }
