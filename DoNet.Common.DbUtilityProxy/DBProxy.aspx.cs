...
{
    public partial class DBProxy1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Request.ContentEncoding = System.Text.Encoding.UTF8;
            Response.HeaderEncoding = Response.ContentEncoding = System.Text.Encoding.UTF8;
            Response.ContentType = "text/plain";
            object result = "";

            try
            {
                var bs = new byte[Request.InputStream.Length];

                var l = Request.InputStream.Read(bs, 0, bs.Length);
